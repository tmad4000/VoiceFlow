...
struct VoiceCommand: Codable, Identifiable, Equatable, Hashable {
    ...
    static let defaults: [VoiceCommand] = [
        ...
        VoiceCommand(phrase: "undo", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_Z), modifiers: [.command])),
        VoiceCommand(phrase: "redo", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_Z), modifiers: [.command, .shift])),
        VoiceCommand(phrase: "copy", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_C), modifiers: [.command])),
        VoiceCommand(phrase: "paste", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_V), modifiers: [.command])),
        VoiceCommand(phrase: "cut", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_X), modifiers: [.command])),
        VoiceCommand(phrase: "select all", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_A), modifiers: [.command])),
        VoiceCommand(phrase: "save", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_S), modifiers: [.command])),
        VoiceCommand(phrase: "find", shortcut: KeyboardShortcut(keyCode: UInt16(kVK_ANSI_F), modifiers: [.command])),
